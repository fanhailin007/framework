            ...
            <ul class="user-info-list">
              <li class="info-item">
                ...
                <div class="item-content">
                  ...
                  <span class="item-value">前端小白白</span>
                </div>
              </li>
              <li class="info-item">
                <div class="item-icon">
                ...
                <div class="item-content">
                  ...
                  <span class="item-value">1992/8/11</span>
                </div>
              </li>
              <li class="info-item">
                <div class="item-icon">
              ...
              <li class="info-item">
                ...
                <div class="item-content">
                  ...
                  <span class="item-value">集团 - 事业群 - 技术部</span>
                </div>
              </li>
              <li class="info-item">
                <div class="item-icon">
                ...
                <div class="item-content">
                  ...
                  <span class="item-value">广东省 · 深圳市</span>
                </div>
              </li>
              <li class="info-item">
                <div class="item-icon">
                ...
                <div class="item-content">
                  ...
                  <span class="item-value tech-text">JavaScript、Vue、Node</span>
                </div>
              </li>
              <li class="tags-item">
                <vab-divider />
                ...
                <el-space wrap>
                  <el-tag v-for="tag in dynamicTags" :key="tag" class="user-tag" effect="plain" round>
                    {{ tag }}
                  </el-tag>
                </el-space>
              </li>
